...
export default function HubACS({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.menu}>
          <TouchableOpacity style={styles.botaoMenu} onPress={() => navigation.navigate('TelaAvaliacao')}>
            <Text style={styles.emoji}>📝</Text>
            <Text style={styles.botaoTexto}>{t('nova_avaliacao')}</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.botaoMenu} onPress={() => navigation.navigate('ConsultasAnteriores')}>
            <Text style={styles.emoji}>📋</Text>
            <Text style={styles.botaoTexto}>{t('minhas_avaliacoes')}</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.botaoMenu} onPress={() => navigation.navigate('PerfilACS')}>
            <Text style={styles.emoji}>👤</Text>
