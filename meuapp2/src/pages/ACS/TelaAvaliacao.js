...
export default function TelaAvaliacao({ navigation }) {
  ...
  const handleContinuar = async () => {
    ...
    try {
      ...
      if (json.status === 'ok' && json.id_avaliacao) {
        navigation.navigate('TelaHistorico', { idAvaliacao: json.id_avaliacao });
      } else {
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    borderColor: '#B6D4D4', borderWidth: 1, marginBottom: 16, color: 'black',
  },
  picker: {
