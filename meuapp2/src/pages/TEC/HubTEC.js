...
export default function HubTEC({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.menu}>
          <TouchableOpacity style={styles.botaoMenu} onPress={() => navigation.navigate('TelaSupervisaoTEC')}>
            <Text style={styles.emoji}>📝</Text>
            <Text style={styles.botaoTexto}>{t('nova_avaliacao')}</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.botaoMenu} onPress={() => navigation.navigate('ConsultasAnterioresTEC')}>
            <Text style={styles.emoji}>📋</Text>
            <Text style={styles.botaoTexto}>{t('minhas_avaliacoes')}</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.botaoMenu} onPress={() => navigation.navigate('PerfilTEC')}>
            <Text style={styles.emoji}>👤</Text>
