...
export default function TelaHistorico({ navigation, route }) {
  // ✅ Recebe também o supervisionado da tela anterior
  ...
  const handleContinuar = async () => {
    ...
    try {
      ...
      if (json.status === 'ok') {
        // ✅ Repassa o supervisionado para a próxima tela
        navigation.navigate('TelaEstadoVascular', { idAvaliacao, supervisionado });
      } else {
  ...
  <View style={styles.modalContainer}>
    <View style={styles.modalContent}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.boxPergunta}>
          <Image source={require('../../img/enfdir.png')} style={styles.nurse2} />
          <View style={styles.bubble}>
